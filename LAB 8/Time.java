   ...
   */
   ...
   public Time(String militaryTime)
   {
      ...
      else
      {
         ...
         {
            this.hours=Integer.parseInt( militaryTime.substring(0,2));// SEPARATE THE STRING INTO THE HOURS
            this.minutes=Integer.parseInt(militaryTime.substring(3,5));// AND THE MINUTES, CONVERTING THEM TO
